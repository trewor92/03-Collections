...
namespace CollectionApplication1Test
{
    ...
    public class Tests
    {
        ...
        private static int MaxNodeCount = 10000; //
        ...
        public void DepthTraversalTree_Should_Return_Right_Result()
        {
            ...
            DepthTraversalTreeTest(
                ...
                new[] { 1, 12, 13, 14 },
                "DepthTraversalTree should return the right result1"
                );
            ...
            DepthTraversalTreeTest(
                ...
                "DepthTraversalTree should return the right result2"
                );
